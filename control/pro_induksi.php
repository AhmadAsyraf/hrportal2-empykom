...
<head>
	...
	<link rel="stylesheet" href="./assets/css/demo/asymmetric-agency/asymmetric-agency-case-studies.css">
	...
	<title>EMPICOM - Program Induksi</title>
...
<body class="lqd-cc-outer-hidden" data-lqd-cc="true" data-mobile-nav-breakpoint="1199" data-mobile-nav-style="modern" data-mobile-nav-scheme="dark" data-mobile-nav-trigger-alignment="right" data-mobile-header-scheme="gray" data-mobile-logo-alignment="default" data-overlay-onmobile="false">
	<div id="wrap">
		...
		<header class="site-header main-header main-header-overlay sticky-header-noshadow main-header-dynamiccolors is-not-stuck" data-sticky-header="true" data-sticky-values-measured="false" data-sticky-options='{"disableOnMobile":true,"stickyTrigger":"first-section","dynamicColors":true}'>
						...
						<div class="header-module module-logo no-rotate navbar-brand-plain pt-40 pb-30">
							<a class="navbar-brand" href="index.php" rel="home">
								<span class="navbar-brand-inner">
									<img class="logo-dark" src="./assets/images/demo/asymmetric-agency/logo/Perodua-logo.png" alt="Hub Theme">
									<img class="logo-default" src="./assets/images/demo/asymmetric-agency/logo/PERODUA.svg" alt="Hub Theme" style="height: 70px; width: auto;">
								</span>
							</a>
						</div>
					</div>
				...
				<div class="lqd-stickybar w-full h-full relative vertical-rl overflow-visible flex justify-between">
					<div class="col lqd-head-col justify-center">
						<div class="py-10 ld-module-sd header-module header-module-rotate ld-module-sd-hover no-rotate ld-module-sd-right pointer-events-auto">
							...
							<div class="ld-module-dropdown collapse w-350" aria-valuemin="0" aria-valuenow="0" aria-valuemax="100" id="header-sidedrawer" role="slider">
									...
									<div class="w-full relative flex flex-wrap h-full justify-between -mr-15 -ml-15">
										<div class="w-full flex flex-auto flex-col items-start justify-start px-15">
											<div class="header-module module-logo no-rotate navbar-brand-plain py-45">
												<a class="navbar-brand" href="index.php" rel="home">
													<span class="navbar-brand-inner">
														<img class="logo-light" src="./assets/images/demo/asymmetric-agency/logo/Perodua-logo.png" alt="Hub Theme">
														<img class="logo-default" src="./assets/images/demo/asymmetric-agency/logo/Perodua-logo.png" alt="Hub Theme" style="height: 70px; width: auto;">
													</span>
												</a>
											</div>
										</div>
											...
											<div class="header-module no-rotate">
												<div class="lqd-fancy-menu lqd-custom-menu lqd-menu-td-none">
													<ul class="reset-ul" data-localscroll="true" data-localscroll-options='{"itemsSelector":"> li > a", "trackWindowScroll": true, "includeParentAsOffset": true}'>
														<li class="mb-15">
															<a class="flex leading-1/5em hover:text-primary" href="index.php" aria-current="page">Laman Utama</a>
														</li>
														<li class="mb-15">
															<a class="flex leading-1/5em hover:text-primary" href="#visi&misi">Profile</a>
														</li>
														<li class="mb-15 menu-item-has-children">
															<a class="flex leading-1/5em hover:text-primary" href="polisiHR.php">Polisi HR<span class="submenu-expander relative"></span></a>
														</li>
														<li class="mb-15">
															<a class="flex leading-1/5em hover:text-primary" href="HRteam.php">HR Team</a>
														</li>
														<li class="mb-15">
															<a class="flex leading-1/5em hover:text-primary" href="disiplin.php">Disiplin</a>
														</li>
														<li class="mb-15">
															<a class="flex leading-1/5em hover:text-primary" href="arkib.php">Arkib</a>
														</li>
														<li class="mb-15">
															<a class="flex leading-1/5em hover:text-primary" href="capaian.php">Capaian</a>
														</li>
														<li class="mb-15">
															<a class="flex leading-1/5em hover:text-primary" href="artikel.php">Artikel</a>
														</li>
										...
										<div class="w-full flex flex-auto flex-col items-start justify-end px-15">
											<div class="ld-fancy-heading">
												<p class="mb-1/5em ld-fh-element">
													<a href="#">Empicom@Perodua.com</a>
												</p>
											</div>
											<div class="ld-fancy-heading ">
												<p class="mb-2em leading-1/5em text-14 text-black ld-fh-element"> Looking for collaboration for your next project? Do not hesitate to contact us to say hello.</p>
											</div>
											<div class="header-module no-rotate">
						...
						<div class="header-module header-module-rotate py-10">
							<div class="lqd-fancy-menu lqd-menu-td-none pos-static">
								<ul class="reset-ul inline-nav flex pointer-events-auto -mr-10 -ml-10">
									<li class="my-10">
										<a href="#" target="_blank" data-lqd-interactive-color="false"> Social —</a>
									</li>
									<li class="my-10">
										<a href="#" target="_blank" data-lqd-interactive-color="false"> Fb.</a>
									</li>
									<li class="my-10">
										<a href="#" target="_blank" data-lqd-interactive-color="false"> Ig.</a>
									</li>
									<li class="my-10">
										<a href="#" target="_blank" data-lqd-interactive-color="false"> Tw.</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="col lqd-head-col flex-col items-center justify-center">
						<div class="header-module lqd-active-row-light header-module-rotate py-10">
							<div class="lqd-scrl-indc pointer-events-auto" data-lqd-scroll-indicator="true">
								<a class="pointer-events-auto text-black vertical-rl rotate-180" href="#wrap" data-localscroll="true" data-lqd-interactive-color="false">
		...
		<main class="content bg-white" id="lqd-site-content">
			<div id="lqd-contents-wrap">
				...
				<!-- Start Banner -->
				<section class="lqd-section banner-case-studies py-185 bg-no-repeat bg-cover bg-center" id="banner" style="background-image: url(./assets/images/demo/asymmetric-agency/case-studies/banner.jpg);" data-section-luminosity="dark">
					<div class="container">
						<div class="row">
							<div class="col col-12 text-center">
								<h1 class="ld-fh-element lqd-highlight-underline lqd-highlight-grow-left text-decoration-default lqd-split-chars mb-0 text-130 text-white" data-split-text="true" data-split-options='{"type":"chars, words"}' data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":".lqd-chars > .split-inner","duration":"1800","delay":"80","ease":"power4.out","direction":"forward","initValues":{"opacity":0},"animations":{"opacity":1}}'> Program Induksi </h1>
							</div>
						</div>
					</div>
				</section>
				...
				<section class="lqd-section case-studies" id="case-studies" data-section-luminosity="light" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":".animation-element","duration":"1800","delay":"180","ease":"power4.out","direction":"forward","initValues":{"x":60,"scaleX":0.85,"scaleY":0.85,"rotationY":35,"transformOriginX":50,"transformOriginY":50,"transformOriginZ":"0px","opacity":0},"animations":{"x":0,"scaleX":1,"scaleY":1,"rotationY":0,"transformOriginX":50,"transformOriginY":50,"transformOriginZ":"-180px","opacity":1}}'>
					<div class="container-fluid p-1">
						<div class="row m-0">
											...
											<div class="lqd-fb-content-wrap lqd-overlay will-change-transform transform-style-3d backface-hidden" data-stacking-factor="0.5">
												<div class="lqd-fb-img lqd-overlay rounded-4 overflow-hidden">
													<figure class="w-full h-full" data-responsive-bg="true">
														<img class="h-full object-cover visibility-hidden" width="720" height="813" src="./assets/images/demo/asymmetric-agency/case-studies/case-studies-row-1.jpg" alt="case studies">
													</figure>
													<div class="lqd-fb-bg lqd-overlay"></div>
													<div class="lqd-fb-hover-overlay lqd-overlay"></div>
												</div>
												<div class="lqd-fb-content lqd-overlay flex items-end">
													<div class="lqd-fb-content-inner relative w-full py-3rem px-3/5rem">
															<!--	<span class="lqd-fb-icon flex mb-2rem">
															<i class="lqd-icn-ess icon-lqd-atom"></i>
														</span> -->
														<h2 class="mb-0 font-bold text-32">Penjawatan: </h2>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="lqd-fb-inner lqd-overlay">
										...
										<div class="flex flex-wrap items-center lqd-overlay perspective backface-hidden" data-hover3d="true">
											<div class="lqd-fb-content-wrap lqd-overlay will-change-transform transform-style-3d backface-hidden" data-stacking-factor="0.5">
												<div class="lqd-fb-img lqd-overlay rounded-4 overflow-hidden">
													<figure class="w-full h-full" data-responsive-bg="true">
														<img class="h-full object-cover visibility-hidden" width="726" height="817" src="./assets/images/demo/asymmetric-agency/case-studies/case-studies-row-2.jpg" alt="case studies">
													</figure>
													<div class="lqd-fb-bg lqd-overlay"></div>
													<div class="lqd-fb-hover-overlay lqd-overlay"></div>
												</div>
												<div class="lqd-fb-content lqd-overlay flex items-end">
													<div class="lqd-fb-content-inner relative w-full py-3rem px-3/5rem">
														...
														<h2 class="mb-0 font-bold text-32">Program Induksi</h2>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="col col-12 col-md-6 col-lg-3 p-0 animation-element">
							<a href="latihan_industri.php#li">
								<div class="lqd-fb round h-pt-125 lqd-fb-style-6 relative rounded-4" data-lqd-zindex="true">
									<div class="lqd-fb-inner lqd-overlay">
										<div class="lqd-fb-shadow"></div>
										<div class="flex flex-wrap items-center lqd-overlay perspective backface-hidden" data-hover3d="true">
											<div class="lqd-fb-content-wrap lqd-overlay will-change-transform transform-style-3d backface-hidden" data-stacking-factor="0.5">
												<div class="lqd-fb-img lqd-overlay rounded-4 overflow-hidden">
													<figure class="w-full h-full" data-responsive-bg="true">
														<img class="h-full object-cover visibility-hidden" width="722" height="813" src="./assets/images/demo/asymmetric-agency/case-studies/case-studies-row-3.jpg" alt="case studies">
													</figure>
													<div class="lqd-fb-bg lqd-overlay"></div>
													<div class="lqd-fb-hover-overlay lqd-overlay"></div>
												</div>
												<div class="lqd-fb-content lqd-overlay flex items-end">
													<div class="lqd-fb-content-inner relative w-full py-3rem px-3/5rem">
														...
														<h2 class="mb-0 font-bold text-32">Latihan Industri</h2>
													</div>
												</div>
											</div>
										</div>
							...
							<div class="col col-12 col-md-6 col-lg-3 p-0 animation-element">
							<a href="kekosongan_jawatan.php#kj">
								<div class="lqd-fb round h-pt-125 lqd-fb-style-6 relative rounded-4" data-lqd-zindex="true">
									<div class="lqd-fb-inner lqd-overlay">
										<div class="lqd-fb-shadow"></div>
										<div class="flex flex-wrap items-center lqd-overlay perspective backface-hidden" data-hover3d="true">
											<div class="lqd-fb-content-wrap lqd-overlay will-change-transform transform-style-3d backface-hidden" data-stacking-factor="0.5">
												<div class="lqd-fb-img lqd-overlay rounded-4 overflow-hidden">
													<figure class="w-full h-full" data-responsive-bg="true">
														<img class="h-full object-cover visibility-hidden" width="722" height="813" src="./assets/images/demo/asymmetric-agency/case-studies/case-studies-row-4.jpg" alt="case studies">
													</figure>
													<div class="lqd-fb-bg lqd-overlay"></div>
													<div class="lqd-fb-hover-overlay lqd-overlay"></div>
												</div>
												<div class="lqd-fb-content lqd-overlay flex items-end">
													<div class="lqd-fb-content-inner relative w-full py-3rem px-3/5rem">
														...
														<h2 class="mb-0 font-bold text-32">Kekosongan Jawatan</h2>
													</div>
												</div>
											</div>
										</div>
				...
				<section id="pi"class="lqd-section how-it-work py-90" data-custom-animations="true" data-ca-options='{"triggerHandler":"inview","animationTarget":".animation-element","duration":"1800","delay":"180","ease":"power4.out","direction":"forward","initValues":{"y":35,"transformOriginX":50,"transformOriginY":50,"transformOriginZ":"0px","opacity":0},"animations":{"y":0,"transformOriginX":50,"transformOriginY":50,"transformOriginZ":"0px","opacity":1}}' data-section-luminosity="light">
					<div class="container">
									...
									<div class="container-fluid">
										<div class="row items-center">
											...
											<div class="col-8 animation-element">
												<h6 class="ld-fh-element mb-0/5em text-12 uppercase tracking-0/01em font-normal text-black"> Program Induksi</h6>
											</div>
											...
											<div class="container">
												<div class="items-center">
													<div class="flex flex-col pr-30 pl-5percent module-col-19">
														...
														<h4>Objektif-objektif perlaksaan program induksi adalah untuk:</h4><br>
														<ul>
															<li>
																<p>Memberi pendedahan kepada kakitangan baru mengenai struktur organisasi, budaya kerja serta nilai-nilai Syarikat kumpulan Perodua.</p>
															</li>
															<li>
																<p>Memberi pengetahuan asas mengenai produk-produk Syarikat.</p>
															</li>
															<li>
																<p>Memberi pemahaman kepada kakitangan baru tentang fungsi utama divisyen Perkilangan, Jualan dan Pemasaran, Perkhidmatan Selepeas Jualan dan Perkhidmatan Korporat secara menyeluruh.</p>
															</li>
															<li>
																<p>Mempersiapkan kakitangan untuk menghadapi persekitaran kerja yang baru.</p>
															</li>
															<li>
																<p>Mengukuhkan kesedaran terhadap tanggungjawab sebagai kakitangan di dalam organisasi dan hubungan antara kakitangan.</p>
															</li>
														</ul><br><br><br>
														<h6>Program Induksi</h6>
														<?php
															include('dbconn.php');

															// Fetch unique categories from the database and sort by pi_category
															$sql_categories = "SELECT DISTINCT pi_category FROM pro_induksi WHERE pi_category IN ('Program Eksekutif', 'Program Bukan Eksekutif', 'Program Operator Pengeluaran')";
															...
															if ($result_categories->num_rows > 0) {
																...
																while ($row = $result_categories->fetch_assoc()) {
																	...
																	echo '<a href="uploads/'. $pi_category . '</a>'; // Category title
																	echo '</h2>';
																	echo '</div>';
																	...
																	while ($row_title = $result_titles->fetch_assoc()) {
																		...
																		echo '<li>';
																		echo '<p>';
																		echo '<a href="uploads/' . $row_title['pi_doc'] . '" target="_blank" > ' ; // Title with link to pi_doc
																		echo '<h7 class="card-title" style="color: red;">' . $pi_category . '</h7>'; // Changing the color of the category title to red
																		echo ' </a>';
																		echo '</p>';
																		echo '</li>';
																		echo '</ul>';
						...
						<div style="text-align: center;">
							<a style="color: red; float: right;" href="latihan_industri.php"><strong>Next Page </strong>>></a>
						</div>
					</div>
				</section>
				<!-- End How It Work -->
				...
				<div class="row items-start">
							...
							<div class="row">
								<div class="col col-12 col-md-4 mb-35">
									<div class="lqd-imggrp-img-container mb-35">
										<span class="navbar-brand-inner">
											<img class="logo" src="./assets/images/demo/asymmetric-agency/logo/Perodua-logo.png" style="height: 50px; width: auto;">
										</span>
									</div>
								</div>
								<div class="col col-6 col-md-4 mb-35">
									<h3 class="ld-fh-element mb-2/15em text-14 tracking-0/1em text-white">EMPICOM</h3>
									<div class="lqd-fancy-menu lqd-custom-menu lqd-menu-td-none">
										<ul class="reset-ul">
											<li class="w-full relative flex items-center flex-wrap mb-5">
												<a class="text-gray-400 hover:text-white" href="#wrap">Laman Utama</a>
											</li>
											<li class="w-full relative flex items-center flex-wrap mb-5">
											...
											<li class="w-full relative flex items-center flex-wrap mb-5">
												<a class="text-gray-400 hover:text-white" href="#">About Us</a>
											</li>
					...
					<div class="col col-12 col-md-6 col-lg-3">
						<div class="w-full relative flex flex-col pt-40 border-top border-white-10 mb-35">
							...
							<p class="ld-fh-element mb-0/5em text-18 text-white"> 015-9219 2497</p>
							...
							<p class="ld-fh-element mb-0/5em text-18 text-white">hr@perodua.com</p>
						</div>
					</div>
					<div class="col col-12 col-md-6 col-lg-3">
						<div class=" pt-40 border-top border-white-10 mb-35">
							...
							<ul class="social-icon social-icon-border-none social-icon-md text-28">
								<li>
									<a class="text-28 text-gray-400 hover:text-white" href="https://www.facebook.com/Perodua/?locale=ms_MY" target="_blank">
								...
								<li>
									<a class="text-28 text-gray-400 hover:text-white" href="https://twitter.com/perodua?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank">
								...
								<li>
									<a class="text-28 text-gray-400 hover:text-white" href="https://www.instagram.com/perodua/" target="_blank">
										<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" fill="currentColor">
					...
					<div class="col col-12 col-md-6">
						<div class="lqd-fancy-menu lqd-menu-td-none -mx-15">
							<ul class="reset-ul inline-nav">
								<li class="mx-15">
									<a class="text-12 text-gray-400 hover:text-white" href="#" target="_blank"> </a>
								</li>
								<li class="mx-15">
									<a class="text-12 text-gray-400 hover:text-white" href="#" target="_blank"> Perodua</a>
								</li>
							</ul>
						</div>
					</div>
					<div class="col col-12 col-md-6 text-end sm:text-start">
						<p class="ld-fh-element mb-0/5em text-14"> © 2024 Perodua.</p>
					</div>
				</div>
			</div>
		</section>
	...
	<!-- Contact Modal Mini -->
	<div id="lity-modal-mini" class="lqd-modal lity-hide" data-modal-type="box">
		<div class="lqd-modal-inner">
			<div class="lqd-modal-head"></div>
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col col-12 p-0">
							<div class="ld-fancy-heading">
								<h2 class="ld-fh-element pb-1em mt-5 mb-1/25em text-20">Contact us</h2>
							</div>
							<div class="lqd-contact-form lqd-contact-form-inputs-round lqd-contact-form-button-block lqd-contact-form-button-round mb-2em">
								<div role="form" lang="en-US">
									...
									<form action="#" method="post" novalidate="novalidate" data-status="init">
										<p>
											<span class="lqd-form-control-wrap block mb-20">
												<input class="text-gray-300 text-size-inherit font-medium bg-gray-100 rounded-4 border-none px-2em" type="text" name="your-name" value="" size="40" aria-required="true" aria-invalid="false" placeholder="Name">
											</span>
											<span class="lqd-form-control-wrap block mb-20">
												<input class="text-gray-300 text-size-inherit font-medium bg-gray-100 rounded-4 border-none px-2em" type="email" name="your-email" value="" size="40" aria-required="true" aria-invalid="false" placeholder="Email">
											</span>
											<span class="lqd-form-control-wrap block mb-20">
												<textarea class="text-gray-300 text-size-inherit font-medium bg-gray-100 rounded-4 border-none px-2em" name="your-message" cols="10" rows="3" aria-invalid="false" placeholder="Message"></textarea>
											</span>
										</p>
										<p>
											<input type="submit" value="Send Request" class="has-spinner font-medium h-40 border-none bg-primary text-white">
										</p>
