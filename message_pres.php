...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="./assets/css/demo/modern-agancy/base.css">
		<link rel="stylesheet" href="./assets/css/demo/modern-agancy/modern-agency.css">
        ...
        <link href="./assets/images/demo/modern-agency/logo/PERODUA.svg" rel="icon">
	    <link href="./assets/images/demo/modern-agency/logo/Perodua-logo.png" rel="apple-touch-icon">
			...
			<header id="site-header" class="main-header main-header-overlay" data-sticky-header=" true" data-sticky-values-measured="false" data-sticky-options='{"disableOnMobile": true}'>
				<section class="lqd-section w-full flex flex-row items-center justify-between pr-45 pl-25 md:hidden">
					<div class="w-65percent flex justify-start items-stretch lg:w-full">
						<div class="ld-module-sd ld-module-sd-hover ld-module-sd-left self-center">
							<button class="border-none bg-transparent nav-trigger flex relative items-center justify-center style-2 collapsed pointer-events-auto p-0" aria-expanded="false" data-ld-toggle="true" data-toggle-options='{"cloneTriggerInTarget": false, "type": "hover"}' data-bs-toggle="collapse" data-bs-target="#lqd-drawer-seide-left">
							...
							<div class="ld-module-dropdown collapse absolute" id="lqd-drawer-seide-left">
								<div class="ld-sd-wrap">
									<div class="ld-sd-inner flex-row">
										<section class="lqd-section link-black link-leading-1/5em flex flex-col items-start justify-between p-10">
											<div class="py-30 module-logo flex navbar-brand-plain">
												<a class="navbar-brand flex p-0 relative" href="./index.php" rel="home">
													<span class="navbar-brand-inner post-rel">
														<img class="logo-default" src="./assets/images/demo/modern-agency/logo/lg-wht-bg.png" alt="Hub Theme" style="height: 120px; width: auto;">
													</span>
												</a>
											</div>
											...
											<div class="flex flex-col">
												<div class="ld-fancy-heading relative">
													<p class="ld-fh-element mb-1/5em relative text-black text-15">@HR_Portal.com</p>
												</div>
												<div class="ld-fancy-heading relative">
													<p class="ld-fh-element relative text-10 leading-2em mb-2em">We encourage you to explore the portal thoroughly and reach out to the HR team if you have any questions or need further assistance. Together, let's make the most of the resources available to you.</p>
												</div>
												<div class="social-icons-wrapper gap-20">
													<span class="grid-item">
														<a class="bg-white icon social-icon" href="https://twitter.com/perodua?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank">
													...
													<span class="grid-item">
														<a class="bg-white icon social-icon" href="https://www.youtube.com/@Perodua" target="_blank">
															<span class="sr-only">Youtube</span>
															<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><path d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"/></svg>
														</a>
													</span>
													<span class="grid-item">
														<a class="bg-white icon social-icon" href="#" target="_blank">
															<span class="sr-only">Facebook</span>
															<svg xmlns="https://www.facebook.com/Perodua/?locale=ms_MY" height="1em" viewBox="0 0 512 512"><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"/></svg>
														</a>
													</span>
												</div>
											</div>
						...
						<div class="navbar-brand-plain flex py-35 pr-50 pl-25 module-logo">
							<a class="navbar-brand flex p-0 relative" href="./index-modern-agency.html" rel="home">
								<span class="navbar-brand-inner post-rel">
									<img class="logo-default" src="./assets/images/demo/modern-agency/logo/Perodua-logo.png" alt="Hub Theme" style="height: 35px; width: auto;">
								</span>
							</a>
						</div>
						<div class="module-primary-nav flex lg:w-full">
							<div class="navbar-collapse inline-flex p-0 lqd-submenu-default-style" id="main-header-collapse" aria-expanded="false" role="navigation">
								<ul id="primary-nav" class="main-nav flex reset-ul inline-ul lqd-menu-counter-right lqd-menu-items-inline main-nav-hover-fade-inactive link-15 link-bold lg:justify-end" data-submenu-options='{"toggleType": "fade", "handler": "mouse-in-out"}' data-localscroll="true" data-localscroll-options='{"itemsSelector":"> li > a", "trackWindowScroll": true, "includeParentAsOffset": true}'>
									<li class="is-active">
										<a class="text-blue-300" href="index.php">Home</a>
									</li>
									<li>
										<a class="text-blue-300" href="polisiHR.php">Policies</a>
									</li>
									<li>
										<a class="text-blue-300" href="discipline.php">Discipline</a>
									</li>
									<li>
										<a class="text-blue-300" href="archive.php">
											<span>Archive</span>
											<span class="submenu-expander">
												<svg class="w-1em" xmlns="http://www.w3.org/2000/svg" width="21" height="32" viewbox="0 0 21 32" style="width: 1em; height: 1em;">
									...
									<li>
										<a class="text-blue-300" href="achievements.php">Achievements</a>
									</li>
									<li>
										<a class="text-blue-300" href="about_us.php">About Us</a>
									</li>
									<li>
										<a class="text-blue-300" href="contact_us.php"><span class="link-badge text-primary">Contact Us</span></a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="w-35percent flex justify-end items-center lg:hidden">
						<p class="text-end mb-0 mr-25">
							<span class="text-12 leading-1em text-blue-200">Contact Us</span>
							<br>
							<strong class="text-15 tracking-0 leading-30 text-orange-500">+ 1 234 56 78</strong>
						</p>
						<a href="./schedule/calendar_event.php" class="button btn whitespace-nowrap btn-solid btn-md btn-hover-txt-switch btn-hover-txt-switch-y bg-white rounded-100 box-shadow-center text-13 font-bold uppercase tracking-0/3 leading-1/5em text-blue-900 hover:text-white hover:bg-primary" data-lity="#contact-modal">
							<span class="btn-txt" data-text="Calendar Event" data-split-text="true" data-split-options='{"type":  "chars, words"}'>Company Calendar</span>
						</a>
					</div>
				</section>
				...
				<div class="w-full flex items-center flex-grow-1 justify-start p-10">
						...
						<div class="w-full flex items-center justify-center flex-grow-1 p-10">
							<span class="-rotate-180 pointer-events-auto pt-70 pb-10 text-black font-medium" data-lqd-interactive-color="true">@HRPortal.com</span>
						</div>
						<div class="w-full flex items-center flex-grow-1 justify-center p-10">
                            ...
                            <div class="col lqd-head-col flex-col justify-end">
                                <div class="header-module module-button pointer-events-auto py-10"><p>ChatBot</p>
                                    <a href="chatbot.php" class="btn btn-icon-block btn-icon-top btn-icon-custom-size btn-icon-circle btn-icon-solid btn-no-label rounded-full bg-white-900 hover:bg-white hover:inner-text-white wrapper" data-lity="#lity-modal-mini" title="Chatbot">
                                        <span class="btn-icon w-60 h-60 text-white text-20 my-0 inner-text-black">
                                            <img src="./assets/images/demo/modern-agency/logo/chatbot.png" alt="Chatbot Image">
                                        </span>
                                    </a>
                                </div>
                            </div>
				...
				<section class="lqd-section lqd-mobile-sec relative">
					<div class="lqd-mobile-sec-inner navbar-header flex items-stretch w-full">
						...
						<button type="button" class="border-none bg-transparent navbar-toggle collapsed nav-trigger style-mobile flex relative items-center p-0" data-ld-toggle="true" data-bs-toggle="collapse" data-bs-target="#lqd-mobile-sec-nav" aria-expanded="false" data-toggle-options='{ "changeClassnames":  {"html":  "mobile-nav-activated"} }'>
						...
						<a class="navbar-brand flex relative" href="#">
							<span class="navbar-brand-inner">
								<img class="logo-default" src="./assets/images/demo/modern-agency/logo.svg" alt="Hub  Theme">
							</span>
						</a>
					</div>
					<div class="lqd-mobile-sec-nav w-full absolute z-10">
						<div class="mobile-navbar-collapse navbar-collapse collapse w-full" id="lqd-mobile-sec-nav" aria-expanded="false" role="navigation">
							<ul id="mobile-primary-nav" class="reset-ul lqd-mobile-main-nav main-nav nav" data-localscroll="true" data-localscroll-options='{"itemsSelector":"> li > a", "trackWindowScroll": true, "includeParentAsOffset": true}'>
								...
								<li>
									<a href="polisiHR.php">Policies</a>
								</li>
								<li>
...
<section class="lqd-section banner">
									...
									<div class="w-full flex flex-col items-start bg-no-repeat pt-10 px-15 pb-50 module-bg"  style="background-image: url('./assets/images/demo/modern-agency/shape-lines-circle.svg');">
										...
										<div class="ld-fancy-heading relative" data-custom-animations="true" data-ca-options='{"animationTarget": ".lqd-split-lines .lqd-lines .split-inner", "duration" : 1800, "startDelay" : 250, "delay" : 180, "ease": "power4.out", "initValues": {"y": "30px", "z": "-130px", "rotationX" : -75, "opacity" : 0} , "animations": {"y": "0px", "z": "0px", "rotationX" : 0, "opacity" : 1}}'>
											<h1 class="ld-fh-element mb-0/5em inline-block relative lqd-highlight-classic lqd-highlight-grow-left lqd-split-lines -tracking-1" data-inview="true" data-transition-delay="true" data-delay-options='{"elements": ".lqd-highlight-inner", "delayType": "transition"}' data-split-text="true" data-split-options='{"type": "lines"}'>
												...
												<mark class="lqd-highlight">
													<span class="lqd-highlight-txt">Mr President</span>
										...
										<div class="w-full">
											<div class="ld-fancy-heading relative mask-text module-text" data-custom-animations="true" data-ca-options='{"animationTarget": ".lqd-split-lines .lqd-lines .split-inner", "duration" : 1800, "startDelay" : 850, "delay" : 180, "ease": "power4.out", "initValues": {"y": "65px"} , "animations": {"y": "0px"}}'>
												<p class="ld-fh-element mb-0/5em inline-block relative text-20 leading-1/5em lqd-split-lines" data-split-text="true" data-split-options='{"type": "lines"}'> This space serves as a direct channel for our President to communicate important updates, insights, and messages to all members of our organization. It ensures transparency and alignment across the company, fostering a sense of unity and shared purpose among employees.</p>
											</div>
										</div>
					...
					<section class="lqd-section icon-box pt-60 pb-30" data-custom-animations="true" data-ca-options='{"triggerHandler" : "inview" , "animationTarget" : ".col" , "duration" : "1800" , "delay" : "180" , "ease" : "power4.out" , "direction" : "forward" , "initValues" : {"y" :30, "scaleY" :1.05, "transformOriginX" : 50, "transformOriginY" : 50, "transformOriginZ" : "0px" , "opacity" :0}, "animations" : {"y" :0, "scaleY" :1, "transformOriginX" : 50, "transformOriginY" : 50, "transformOriginZ" : "0px" , "opacity" :1}}' data-section-luminosity="dark">
					<div class="container">
						...
						<div class="row items-center">
							...
							<div class="col col-12 col-lg-6">
								<div class="w-full relative flex flex-col justify-center border-5 border-black-20 pt-65 pb-50 px-55 mb-30 module-icon-box">
									<div class="iconbox relative flex-col items-start justify-center text-start" data-animate-icon="true" data-plugin-options='{"color" : "rgb(255, 255, 255)"}'>
										<h4>Message from Mr Masaki Ogita</h4><br>
										<div class="accordion accordion-lg accordion-title-underlined  accordion-wrap mb-2em link-black">
											...
											$sql_categories = "SELECT DISTINCT ms_category FROM message_ WHERE ms_category IN ('Message from Mr Masaki Ogita')";
											...
											if ($result_categories->num_rows > 0) {
												...
												while ($row = $result_categories->fetch_assoc()) {
													...
													while ($row_title = $result_titles->fetch_assoc()) {
														...
														echo '<p class="card-title" >' . $row_title['ms_vol'] . '&emsp;' . $row_title['ms_title']  . '</p>'; // Changing the color of the title to red
							...
							<div class="col col-12 col-lg-6">
								<div class="w-full relative flex flex-col justify-center border-5 border-black-20 pt-65 pb-50 px-55 mb-30 module-icon-box">
									<div class="iconbox relative flex-col items-start justify-center text-start" data-animate-icon="true" data-plugin-options='{"color" : "rgb(255, 255, 255)"}'>
										<h4>Message from Mr Takahashi</h4><br>
										<div class="accordion accordion-lg accordion-title-underlined  accordion-wrap mb-2em link-black">
											...
											// Fetch unique categories from the database and sort by pi_category
											$sql_categories = "SELECT DISTINCT ms_category FROM message_ WHERE ms_category IN ('Message from Mr Takahashi')";
											$result_categories = $conn->query($sql_categories);
            ...
            <footer id="site-footer" class="main-footer link-black-60">
				<section class="lqd-section footer-menu border-top border-black-10 pt-110 pb-60">
					<div class="container">
						<div class="row">
							<div class="col col-12 col-md-4 col-xl-3 mt-35 mb-30">
								<div class="ld-fancy-heading relative">
									<p class="mb-15 ld-fh-element relative">Sg. Choh, Loked Bag 226,<br>48009, Rawang Selangor</p>
								</div>
								<div class="ld-fancy-heading relative">
									<p class="m-0 ld-fh-element relative">tel: (03)-6733 8888 </p>
								</div>
								<a href="https://www.perodua.com.my/" class="btn tracking-0/5 whitespace-nowrap btn-naked text-16 font-normal leading-1/75em lowercase text-primary" data-lity="#contact-modal">
									<span class="btn-txt text-primary" data-text="hub@coporation.com">
										<span>www.perodua.com.my</span>
									</span>
								</a>
							</div>
							<div class="col col-6 col-md-4 col-xl-3 mb-30">
								<div class="ld-fancy-heading relative">
									<h3 class="text-20 mb-1/5em ld-fh-element relative">About</h3>
								</div>
								<div class="lqd-fancy-menu lqd-custom-menu relative lqd-menu-td-none">
									<ul class="reset-ul">
										<li class="mb-5">
											<a href="https://www.perodua.com.my/corporate-branding/about-us.html">About Us</a>
										</li>
									    <li class="mb-5">
											<a href="http://careers.perodua.com.my/auth">Careers</a>
										</li>
										<li>
											<a href="https://www.perodua.com.my/">Blog</a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="col col-12 col-md-6 col-lg-3">
							<div class=" pt-40 border-top border-white-10 mb-35">
								<h6 class="ld-fh-element mb-1/75em text-17 uppercase tracking-0/1em text-orange"> Follow Us</h6>
					...
					<div class="container">
						<div class="row">
							<div class="col col-12 flex flex-col items-center">
								...
								<div class="w-full flex flex-wrap items-center justify-between py-60 module-last">
									<div class="w-50percent flex items-start sm:w-full sm:justify-center">
										<div class="ld-fancy-heading relative">
											<p class="ld-fh-element mb-0/5em inline-block relative">© Siniy.2024 HR Portal Perodua. All rights reserved. </p>
										</div>
									</div>
						...
						<div class="row m-0 min-h-100vh items-center">
							<div class="col col-12 col-md-6 pr-100 module-content">
								<div class="ld-fancy-heading">
									<h2 class="ld-fh-element mb-0/75em text-122 leading-0/8em font-medium text-black">Send a <span>message.</span></h2>
								</div>
								<div class="ld-fancy-heading">
										...
										<div class="col col-md-6 p-0">
											...
											<div class="ld-fancy-heading relative mb-10">
												<p class="ld-fh-element mb-0/5em inline-block relative">
													<a href="#" class="text-16 font-bold leading-1/2em text-black">careers@hub.com </a>
												</p>
											</div>
										</div>
										<div class="col col-md-6 p-0">
											...
											<div class="ld-fancy-heading relative">
												<p class="ld-fh-element mb-0/5em inline-block relative">
													<a href="#" class="text-16 font-bold leading-1/2em text-black">info@hub.com</a>
												</p>
											</div>
										</div>
									</div>
