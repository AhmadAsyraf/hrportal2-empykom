					...
					<div class="container">
						<div class="row">
							<div class="col col-12 col-md-4 col-xl-3 mt-35 mb-30">
								...
								<a class="btn tracking-0/5 whitespace-nowrap btn-naked text-16 font-normal leading-1/75em lowercase text-primary"  >
						...
						<div class="col col-12 col-md-6 col-lg-3">
							<div class=" pt-40 border-top border-white-10 mb-35">
								...
								<ul class="social-icon social-icon-border-none social-icon-md text-28 ">
									<li>
										<a class="text-28 text-gray-900 hover:text-black" href="https://www.facebook.com/Perodua/?locale=ms_MY" target="_blank">
									...
									<li>
										<a class="text-28 text-gray-900 hover:text-black" href="https://twitter.com/perodua?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank">
									...
									<li>
										<a class="text-28 text-gray-900 hover:text-black" href="https://www.instagram.com/perodua/" target="_blank">
											<svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512" fill="currentColor">
