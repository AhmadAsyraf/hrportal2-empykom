...
$sql = "SELECT pi_title, pi_category, pi_doc FROM pro_induksi                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ";
...
// Close the database connection
  ...
  <div class="col-12">
      <div class="card recent-sales overflow-auto">
          ...
          <div class="card-body">
              <h5 class="card-title">Employment List<span></span></h5>
              <table class="table table-borderless datatable">
                  ...
                  <tbody>
                    ...
                    foreach ($events as $event) {
                      ...
                      echo "<tr>";
                      echo "<td>" . $event['pi_title'] . "</td>";
                      echo "<td>" . $event['pi_category'] . "</td>";
                      $documentPath = "uploads/" . $event['pi_doc'];
