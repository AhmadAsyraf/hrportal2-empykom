...
<?php
    ...
    $sql = "SELECT jd_title, jd_year, jd_doc, jd_date  FROM jawatan_dalaman                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ";
    ...
    <div class="col-12">
      <div class="card recent-sales overflow-auto">
        ...
        <div class="card-body">
          <h5 class="card-title"> Internal Position <span></span></h5>
          <table class="table table-borderless datatable">
            ...
            <tbody>
              ...
              foreach ($events as $event) {
                ...
                echo "<tr>";
                echo "<td>" . $event['jd_title'] . "</td>";
                echo "<td>" . $event['jd_date'] . "</td>";
                echo "<td>" . $event['jd_year'] . "</td>";
                $documentPath = "uploads/" . $event['jd_doc'];
