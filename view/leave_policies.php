...
if (isset($_SESSION["staff_pass_id"]) && isset($_SESSION["staff_name"])) {
    ...
    if ($result_staff->num_rows > 0) {
        ...
        $sql_policy = "SELECT p_polisi FROM policy WHERE po_id = '$po_id' AND p_category = 'Leave Administration'";
        ...
        if ($result_policy->num_rows > 0) {
            ...
            echo "No policy found for the staff's position with the category Medical Benefit.";
        }
    } else {
