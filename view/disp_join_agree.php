...
$sql = "SELECT pb_year, pb_title, pb_doc FROM perjanjian_bersama                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ";
...
// Close the database connection
 ...
 <div class="col-12">
    <div class="card recent-sales overflow-auto">
        ...
        <div class="card-body">
            <h5 class="card-title">Joint Agreement <span></span></h5>
            <table class="table table-borderless datatable">
                ...
                <tbody>
                    ...
                    foreach ($events as $event) {
                        ...
                        echo "<tr>";
                        echo "<td>" . $event['pb_title'] . "</td>";
                        echo "<td>" . $event['pb_year'] . "</td>";

                        

                        $documentPath = "uploads/" . $event['pb_doc'];
