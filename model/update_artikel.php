  ...
  <section class="section">
    <div class="card">
      <div class="card-body">
        ...
        <form action="../control/ar_process-form.php" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="date" name="ar_date" class="form-control" required><br>
          </div>
          <div class="form-group">
            <label for="image">Upload File:</label>
            <input type="file" name="ar_doc" class="form-control-file" accept="image/*">
          </div><br> 
